<template>
  <section id="projects" class="py-20 bg-[#0d1117] text-[#f0f6fc] font-mono border-t-4 border-black relative">
    <div class="max-w-6xl mx-auto px-4">
      ...
      >
        <div>
          <span class="text-xs font-bold text-[#00ff66] uppercase tracking-widest bg-[#161b22] px-3 py-1 border border-[#00ff66] shadow-[2px_2px_0px_#000] font-silkscreen">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          ...
          :visible-once="{ opacity: 1, y: 0, transition: { duration: 500, delay: (index % 3) * 120, ease: 'easeOut' } }"
        ...
        >
          <div>
            ...
            >
              ...
              <div class="absolute top-2 left-2 bg-black/80 px-2 py-0.5 text-[9px] text-[#00f0ff] font-bold uppercase border border-[#00f0ff] font-silkscreen z-10 pointer-events-none">
                {{ proj.category }}
              </div>

              <!-- Image Index Indicator -->
              <div class="absolute top-2 right-2 bg-black/80 px-2 py-0.5 text-[9px] text-[#ffd700] font-bold uppercase border border-[#ffd700] font-silkscreen z-10 pointer-events-none">
              ...
              >
                <button
                  ...
                  :class="[(activeSlides[proj.id] || 0) === imgIdx ? 'bg-[#00ff66] w-3' : 'bg-white/40']"
                ></button>
              </div>
            </div>
            ...
            <p class="text-xs text-[#8b949e] line-clamp-2 mt-2 leading-relaxed font-mono">
              {{ proj.shortDesc }}
            </p>
          </div>

          <!-- Bottom Meta Stack & Action Buttons -->
          <div class="mt-6 pt-4 border-t-2 border-[#30363d] flex flex-wrap items-center justify-between gap-2">
            <!-- Tech Badges -->
      ...
      >
        ...
        <div class="text-xs text-[#8b949e]">
          SHOWING <span class="text-[#00ff66] font-bold">{{ startIndex + 1 }}-{{ endIndex }}</span> OF <span class="text-[#ffd700] font-bold">{{ filteredProjects.length }}</span> PROJECTS
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <span class="text-xs font-bold text-[#f0f6fc] bg-[#0d1117] px-3 py-1.5 border border-[#30363d]">
            PAGE <span class="text-[#00ff66]">{{ currentPage }}</span> OF <span class="text-[#00ff66]">{{ totalPages }}</span>
          </span>
...
const prevSlide = (proj) => {
  const current = activeSlides[proj.id] || 0;
  activeSlides[proj.id] = (current - 1 + proj.images.length) % proj.images.length;
};
...
const projects = [
  {
    ...
    category: 'game',
    shortDesc: 'Gim balap arkade sepeda fisik terhubung via ESP32 & Unity dengan papan skor real-time.',
    images: [
    ...
    challenge: 'Menciptakan kendali sepeda fisik real-time via IoT ESP32 tanpa latensi pada gim arkade Unity 3D.',
    solution: 'Membangun komunikasi serial JSON berkecepatan tinggi dan algoritma waypoint NPC AI.'
  },
  {
    id: 'mindescape',
    title: 'MindEscape – VR Escape Room',
    category: 'game',
    shortDesc: 'Gim Virtual Reality teka-teki ruang eskapisme 3D imersif dengan interaksi objek fisik.',
    images: [
    ...
    demoUrl: 'https://youtube.com/preview',
    challenge: 'Mengatasi mabuk gerak (motion sickness) saat mengeksplorasi ruang simulasi virtual.',
    solution: 'Menerapkan tata letak imersif, pengoptimalan pencahayaan 90 FPS, dan interaksi tangan intuitif.'
  },
  {
    id: 'mathrift',
    title: 'MathRift – Educational Platformer',
    category: 'game',
    shortDesc: 'Gim 2D platformer edukasi matematika dengan mekanik boss battle & integrasi Firestore.',
    images: [
    ...
    demoUrl: 'https://youtube.com/preview',
    githubUrl: 'https://github.com/MyusiZ3/Creative_Portfolio',
    challenge: 'Mendesain kurva kesulitan teka-teki matematika tanpa merusak ritme keseruan platformer.',
    solution: 'Menggabungkan mekanika kartu jawaban dengan animasi spritework pixel-art yang responsif.'
  },
  {
    id: 'stellar',
    title: 'Stellar Adventures – AR Game',
    category: 'game',
    shortDesc: 'Gim Augmented Reality ruang angkasa yang memadukan dunia fisik dan obyek digital 3D.',
    images: [
    ...
    demoUrl: 'https://youtube.com/preview',
    challenge: 'Pelacakan bidang datar dan kestabilan objek 3D di area ruangan berorientasi acak.',
    solution: 'Menggunakan algoritma AR plane detection dan optimasi model low-poly 3D.'
  },
  {
    id: 'uasprak',
    ...
    challenge: 'Menyusun alur manajemen jadwal & pelaporan bagi ratusan asisten praktikum.',
    solution: 'Merancang antarmuka modular berpresisi tinggi dengan pengujian prototipe interaktif.'
  },
  {
    id: 'empedu',
    title: 'empEDU – Mobile App Design',
    category: 'app',
    shortDesc: 'Aplikasi edukasi interaktif untuk membantu siswa memantau progres belajar mandiri.',
    images: [
    ...
    githubUrl: 'https://github.com/MyusiZ3/Creative_Portfolio',
    challenge: 'Meningkatkan keterlibatan siswa dalam mempelajari materi yang kompleks.',
    solution: 'Mengintegrasikan elemen gamifikasi dan alur pengguna yang intuitif.'
  },
  {
    id: 'iudex',
    title: 'IUDEX – Team Portfolio Web',
    category: 'web',
    shortDesc: 'Situs web portofolio tim dengan animasi bento grid dan tata letak modern.',
    images: [
    ...
    githubUrl: 'https://github.com/MyusiZ3/Creative_Portfolio',
    challenge: 'Menampilkan karya kolektif tim secara profesional dan responsif di seluruh layar.',
    solution: 'Mengimplementasikan tata letak bento grid modern dan transisi interaktif.'
  },
  {
    id: 'arch',
    title: 'Arch – Personal Portfolio',
    category: 'web',
    shortDesc: 'Rancangan portofolio web pribadi minimalis dengan tipografi tebal dan estetika bersih.',
    images: [
    ...
    challenge: 'Menciptakan ruang portofolio yang bersih tanpa kehilangan identitas teknis.',
    solution: 'Pemanfaatan ruang negatif dan animasi halus yang mempermudah pembacaan.'
  },
  {
    id: 'merch',
    title: 'Merch – Event Merchandise Design',
    category: 'web',
    shortDesc: 'Rancangan branding dan aset grafis merchandise fisik untuk acara kreatif.',
    images: [
    ...
    challenge: 'Penerapan identitas acara ke pernak-pernik fisik dengan kualitas cetak tinggi.',
