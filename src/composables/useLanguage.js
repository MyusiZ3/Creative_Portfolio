...
const translations = {
  ...
  ID: {
    ...
    my_proj_desc: "Kurasi peran kunci, penyelesaian masalah pengguna, dan penciptaan pengalaman interaktif yang mendalam di bidang desain, pengembangan, dan teknologi kreatif.",
    my_proj_role: "Peran",
    my_proj_tools: "Stack",
