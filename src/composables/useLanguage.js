...
const translations = {
  ...
  ID: {
    ...
    hero_desc: "Saya gabungkan ide kreatif sama kemampuan teknis buat bikin konten visual yang engaging — dari desain grafis dan UI/UX, sampai pengalaman game yang interaktif.",
    hero_contact: "Hubungi Saya",
    about_title: "Tentang Saya",
    about_intro_1: "Saya Desainer Multimedia yang antusias, dengan background kuat di desain visual, game dev, dan antarmuka yang berfokus pada pengalaman pengguna.",
    about_intro_2: "Punya pengalaman jadi Asisten Praktikum dan lead kreatif di berbagai proyek tim — terbiasa gabungin design thinking dengan skill teknis.",
